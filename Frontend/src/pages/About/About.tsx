    ...
    <main className="about-page">
      ...
      <section className="about-hero">
        ...
        <div className="about-hero-content">
          ...
          <p>
            QUORUM nace de una idea sencilla: utilizar la tecnología
            para transformar problemas reales en productos digitales
            que generen valor.
          </p>
    ...
    <img
      ...
      <section className="about-intro">
        ...
        <div className="intro-content">
          ...
          <p>
            Somos personas interesadas en crear, aprender y resolver
            problemas utilizando tecnología.
          </p>

          <p>
            Desde productos digitales hasta sistemas empresariales,
            trabajamos para convertir ideas complejas en experiencias
      ...
      <section className="story-section">
        ...
        <div className="story-content">
          ...
          <div className="story-text">
            ...
            <p>
              QUORUM comenzó como la iniciativa de un grupo de
              desarrolladores con una visión compartida: crear una
              empresa tecnológica capaz de desarrollar productos
              digitales propios y soluciones para otras empresas.
            </p>

            <p>
              Lo que comenzó como proyectos y experimentación fue
              tomando forma hasta convertirse en una identidad,
              una metodología y una forma de trabajar.
            </p>

            <p>
              Hoy seguimos construyendo desde la misma idea:
              aprender, experimentar y crear tecnología que tenga
              un propósito.
            </p>
      ...
      <section className="values-section">
        ...
        <div className="section-header">
          ...
          <p>
            Estos principios guían las decisiones que tomamos,
            desde una pequeña interacción hasta la arquitectura
      ...
      <section className="team-section">
        ...
        <div className="team-header">
          ...
          <p>
            QUORUM está formado por desarrolladores y personas con
            diferentes habilidades que comparten la misma curiosidad
            por la tecnología.
          </p>
