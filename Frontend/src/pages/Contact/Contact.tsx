    ...
    <main className="contact-page">
      ...
      <section className="contact-hero">
        ...
        <div className="contact-hero-content">
          ...
          <p>
            No necesitas tener todo definido. Cuéntanos tu idea, problema o
            proyecto y nosotros nos encargamos de explorar las posibilidades.
          </p>
        </div>
      ...
      <section className="contact-info-section">
        ...
        <div className="contact-info-grid">
          <a href="mailto:contacto@quórum.tech" className="contact-info-card">
            <span className="contact-info-type">EMAIL</span>

            <h2>contacto@quórum.tech</h2>
          ...
          <a
            ...
            rel="noreferrer"
          >
            <span className="contact-info-type">WHATSAPP</span>
          ...
          <div className="contact-info-card">
            <span className="contact-info-type">UBICACIÓN</span>
      ...
      <section className="contact-form-section">
        <div className="contact-form-intro" id="form-contact">
          <span className="eyebrow">02 / TU PROYECTO</span>
          ...
          <p>
            Completa la información que tengas disponible. No necesitas conocer
        ...
        <form className="contact-form" onSubmit={handleSubmit}>
          ...
          <div className="form-field form-field-full">
            <label htmlFor="message">Cuéntanos sobre el proyecto</label>
          ...
          <div className="form-submit">
            ...
            <small>
              Al enviar este formulario aceptas que podamos contactarte para
          ...
          {status === "success" && (
            <div className="form-success">
              ...
              <p>
                Recibimos la información de tu proyecto. Nos pondremos en
                contacto contigo.
              </p>
            </div>
          )}
      ...
      <section className="contact-process">
        ...
        <div className="contact-process-content">
          <span className="eyebrow">DESPUÉS DE ENVIAR</span>
          ...
          <p>
            Primero queremos entender lo que necesitas. Hablamos contigo,
            analizamos el proyecto y, si existe una buena oportunidad para
            trabajar juntos, definimos los siguientes pasos.
          </p>
      ...
      <section className="contact-final">
        ...
        <a href="mailto:contacto@quórum.tech">contacto@quórum.tech →</a>
      </section>
    </main>
  );
}
