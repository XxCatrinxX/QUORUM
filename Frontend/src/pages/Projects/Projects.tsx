    ...
    <main className="projects-page">
      ...
      <section className="projects-hero">
        ...
        <div className="projects-hero-content">
          ...
          <p>
            Exploramos, diseñamos y construimos productos digitales que buscan
            resolver problemas reales mediante tecnología.
          </p>
        </div>
      ...
      <section className="featured-project-section">
        ...
        <div className="featured-project">
          <div className={`featured-project-visual ${featuredProject.color}`}>
            ...
            <div className="project-visual-content">
              <span className="project-visual-brand">QUORUM</span>
      ...
      <section className="projects-list-section">
        <div className="section-header">
          ...
          <p>
            Algunos proyectos nacen como productos propios y otros surgen a
            partir de necesidades específicas. Todos comparten la misma
            intención: crear algo útil.
          </p>
        </div>
        ...
        <div className="projects-grid">
          {otherProjects.map((project) => (
            <article className="project-card" key={project.number}>
              ...
              >
                <div className={`project-card-visual ${project.color}`}>
      ...
      <section className="projects-approach">
        ...
        <div className="approach-content">
          <span className="eyebrow">MÁS QUE CÓDIGO</span>
          ...
          <p>
            Antes de pensar en tecnologías, pensamos en el problema. Buscamos
            entender qué necesita realmente el usuario, qué necesita el negocio
            y qué podemos construir para conectar ambos puntos.
          </p>
        </div>
      </section>
      ...
      <section className="projects-final-cta">
        ...
        <p>Cuéntanos qué quieres construir y exploremos las posibilidades.</p>

        <Link to="/contacto">Iniciar conversación →</Link>
      </section>
    </main>
  );
}
